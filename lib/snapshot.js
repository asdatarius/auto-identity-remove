...
// Follow the run logs when AIDR_LOG_DIR is set (container/NAS) — snapshots are
// part of the same audit trail and must land on the persistent volume.
const SNAPSHOT_DIR = path.join(
  process.env.AIDR_LOG_DIR || path.join(__dirname, '..', 'logs'),
  'snapshots'
);
